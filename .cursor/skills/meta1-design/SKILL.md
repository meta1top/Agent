---
name: meta1-design
description: Use @meta-1/design component library to build all UI interfaces, pages, and components. Based on Shadcn + Tailwind CSS v4. Use this skill when the user creates, implements, or builds any UI elements, interfaces, pages, forms, login, buttons, inputs, dialogs, cards, lists, navigation, layouts, or any components requiring UI design. Automatically applies when building UI components and interfaces.
